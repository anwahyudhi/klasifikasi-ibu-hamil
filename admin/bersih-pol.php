...
<form class="form-inline pull-right" action="" method="post">
      ...
      <br><br>
            ...
            if (isset($_POST['cariibu'])) {
                $cari = $_POST['cariibu'];
                $sql = "SELECT * FROM ibu_hamil where nama_ibu > '' AND lahir_ibu > '' AND berat_badan > '' AND lingkar_lengan_atas > '' AND hemoglobin > '' AND paritas > '' AND berat_badan < 85 AND hemoglobin < 17 AND paritas < 7 AND nama_ibu LIKE '$cari%' or nama_ibu LIKE '%$cari%' or nama_ibu LIKE '%$cari'";
              }  
              else{
 						$sql = "SELECT * FROM ibu_hamil where nama_ibu > '' AND lahir_ibu > '' AND berat_badan > '' AND lingkar_lengan_atas > '' AND hemoglobin > '' AND paritas > '' AND berat_badan < 85 AND hemoglobin < 17 AND paritas < 7"; 
          }
                        $no  = 1; 
